...
proc create_hier_cell_zups { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins axi_pl_ps/S03_AXI]
  ...
  connect_bd_net -net S01_ACLK_1 [get_bd_pins S01_ACLK] [get_bd_pins axi_pl_ps/S01_ACLK] [get_bd_pins axi_pl_ps/S03_ACLK]
  ...
  connect_bd_net -net TX_AReset_1 [get_bd_pins TX_AReset] [get_bd_pins axi_pl_ps/S03_ARESETN] [get_bd_pins smartconnect_0/aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins pl_clk0] [get_bd_pins axi_pl_ps/ACLK] [get_bd_pins axi_pl_ps/M00_ACLK] [get_bd_pins axi_pl_ps/S00_ACLK] [get_bd_pins ps_axi_periph/ACLK] [get_bd_pins ps_axi_periph/M00_ACLK] [get_bd_pins ps_axi_periph/M01_ACLK] [get_bd_pins ps_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins pl_clk1_0] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXIToStream_orchestr_1_AXIM] [get_bd_intf_pins AXIToStream_orchestr_1/AXIM] [get_bd_intf_pins system_ila_0/SLOT_6_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets AXIToStream_orchestr_1_AXIM]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXIToStream_orchestr_1_stream] [get_bd_intf_pins axis_dwidth_converter_1/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_7_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AXI_PerfectTranslator_0_M00_AXI] [get_bd_intf_pins AXIToStream_orchestr_1/AXIS] [get_bd_intf_pins system_ila_0/SLOT_5_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zups_M00_AXI1] [get_bd_intf_pins AXIToStream_orchestr_0/AXIS] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zups_M01_AXI]
  connect_bd_intf_net -intf_net zups_M01_AXI1 [get_bd_intf_pins UARTDriver_0/axi_slave] [get_bd_intf_pins zups/M01_AXI1]
connect_bd_intf_net -intf_net [get_bd_intf_nets zups_M01_AXI1] [get_bd_intf_pins system_ila_0/SLOT_4_AXI] [get_bd_intf_pins zups/M01_AXI1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zups_M01_AXI1]
  ...
  connect_bd_net -net dma_tx_rst_Res [get_bd_pins dma_tx_rst/Res] [get_bd_pins system_ila_0/probe14] [get_bd_pins xxv_ethernet_0/tx_reset_0]
  ...
  connect_bd_net -net xxv_ethernet_0_stat_tx_packet_large_0 [get_bd_pins system_ila_0/probe21] [get_bd_pins xxv_ethernet_0/stat_tx_packet_large_0]
  ...
  connect_bd_net -net xxv_ethernet_0_stat_tx_total_bytes_0 [get_bd_pins system_ila_0/probe4] [get_bd_pins xxv_ethernet_0/stat_tx_total_bytes_0]
  connect_bd_net -net xxv_ethernet_0_stat_tx_total_good_bytes_0 [get_bd_pins system_ila_0/probe8] [get_bd_pins xxv_ethernet_0/stat_tx_total_good_bytes_0]
  connect_bd_net -net xxv_ethernet_0_stat_tx_total_good_packets_0 [get_bd_pins system_ila_0/probe6] [get_bd_pins xxv_ethernet_0/stat_tx_total_good_packets_0]
  connect_bd_net -net xxv_ethernet_0_stat_tx_total_packets_0 [get_bd_pins system_ila_0/probe18] [get_bd_pins xxv_ethernet_0/stat_tx_total_packets_0]
  connect_bd_net -net xxv_ethernet_0_tx_clk_out_0 [get_bd_pins AXIToStream_orchestr_0/clk] [get_bd_pins AXIToStream_orchestr_1/clk] [get_bd_pins FrameFormer_wrapper_0/ACLK] [get_bd_pins UARTDriver_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins axis_interconnect_0/ACLK] [get_bd_pins axis_interconnect_0/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S01_AXIS_ACLK] [get_bd_pins rst_pl_eth_10g_156M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk] [get_bd_pins xxv_ethernet_0/tx_clk_out_0] [get_bd_pins zups/S01_ACLK] [get_bd_pins zups/Tx_CLK]
  connect_bd_net -net xxv_ethernet_0_tx_unfout_0 [get_bd_pins system_ila_0/probe20] [get_bd_pins xxv_ethernet_0/tx_unfout_0]
  connect_bd_net -net xxv_ethernet_0_user_rx_reset_0 [get_bd_pins rx_rst_n/Op1] [get_bd_pins xxv_ethernet_0/user_rx_reset_0]
  connect_bd_net -net xxv_ethernet_0_user_tx_reset_0 [get_bd_pins rst_pl_eth_10g_156M/ext_reset_in] [get_bd_pins system_ila_0/probe19] [get_bd_pins tx_rst_n/Op1] [get_bd_pins xxv_ethernet_0/user_tx_reset_0]
  connect_bd_net -net zups_Res [get_bd_pins system_ila_0/probe16] [get_bd_pins xxv_ethernet_0/gtwiz_reset_rx_datapath_0] [get_bd_pins xxv_ethernet_0/gtwiz_reset_tx_datapath_0] [get_bd_pins zups/Res]
  connect_bd_net -net zups_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins system_ila_0/probe17] [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0] [get_bd_pins zups/peripheral_aresetn]
  connect_bd_net -net zups_peripheral_reset [get_bd_pins system_ila_0/probe15] [get_bd_pins xxv_ethernet_0/sys_reset] [get_bd_pins zups/peripheral_reset]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zups/zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
