...
connect_bd_intf_net -intf_net [get_bd_intf_nets zups_M00_AXI1] [get_bd_intf_pins AXIToStream_orchestr_0/AXIS] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  ...
  connect_bd_net -net axis_dwidth_converter_1_m_axis_tid [get_bd_pins axis_dwidth_converter_1/m_axis_tid]
  ...
  connect_bd_net -net axis_dwidth_converter_1_m_axis_tstrb [get_bd_pins axis_dwidth_converter_1/m_axis_tstrb]
  connect_bd_net -net axis_dwidth_converter_1_m_axis_tuser [get_bd_pins axis_dwidth_converter_1/m_axis_tuser]
